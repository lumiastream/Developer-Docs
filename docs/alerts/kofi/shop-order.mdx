---
sidebar_position: 3
id: alert-kofi-shop-order
title: Shop Order
description: "created a shop order with {{amount}} {{currency}}"
---

# Shop Order

- **Alert key:** `kofi-shopOrder`
- **Source:** Ko-fi
...
```text
{{username}} just created a shop order with amount {{amount}}
```
