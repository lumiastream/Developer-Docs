---
sidebar_position: 9
id: alert-kick-session-gift-subscriptions
...
- **Alert key:** `kick-sessionGiftSubscriptions`
- **Source:** Kick
...
```json
{
  "alert": "kick-sessionGiftSubscriptions",
  "dynamic": {
    "value": 10,
    "total": 10,
    "previousTotal": 5
...
- `COUNT_IS_MULTIPLE_OF` - Total Session Gift Subscription Count is a multiple of
