---
sidebar_position: 33
id: alert-twitch-prediction-progressed
title: Prediction Progressed
description: "Prediction {{prediction_title}} progressed. The current leader is {{prediction_winning_outcome_title}} with {{prediction_winning_outcome_points}} points"
---

# Prediction Progressed

- **Alert key:** `twitch-predictionProgressed`
- **Source:** Twitch
- **Event list label:** Prediction progressed
...
```json
{
  "alert": "twitch-predictionProgressed",
  "dynamic": {
