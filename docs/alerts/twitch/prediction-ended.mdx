---
sidebar_position: 32
id: alert-twitch-prediction-ended
title: Prediction Ended
description: "Prediction {{prediction_title}} ended. The current leader is {{prediction_winning_outcome_title}} with {{prediction_winning_outcome_points}} points"
---

# Prediction Ended

- **Alert key:** `twitch-predictionEnded`
- **Source:** Twitch
- **Event list label:** Prediction ended
