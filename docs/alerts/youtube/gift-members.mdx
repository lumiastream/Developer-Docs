---
sidebar_position: 3
id: alert-youtube-gift-members
title: Gift Members
description: "gifted {{giftAmount}} {{tier}} members to {{recipients}}"
---

# Gift Members

- **Alert key:** `youtube-giftMembers`
- **Source:** YouTube
- **Event list label:** Gifted `{{giftAmount}}` members

## Default message template

```text
{{gifter}} gifted {{giftAmount}} {{tier}} members to {{recipients}}
```
...
- `RANDOM`
- `GIFT_SUB_EQUAL` - Gift Members Amount is equal to
- `GIFT_SUB_GREATER` - Gift Members Amount is greater than or equal to
- `EQUAL_VARIABLE`
