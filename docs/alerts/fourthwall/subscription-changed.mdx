---
sidebar_position: 8
id: alert-fourthwall-subscription-changed
title: Subscription Changed
description: "subscription changed to {{subscriptionType}}"
---

# Subscription Changed

- **Alert key:** `fourthwall-subscriptionChanged`
- **Source:** Fourthwall
- **Event list label:** Subscription Changed

## Default message template

```text
{{username}} subscription changed to {{subscriptionType}}
```
...
```json
{
  "alert": "fourthwall-subscriptionChanged",
  "dynamic": {
    "value": 100,
    "currency": "USD"
  },
