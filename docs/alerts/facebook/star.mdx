---
sidebar_position: 7
id: alert-facebook-star
title: Star
description: "sent {{amount}} stars"
---

# Star

- **Alert key:** `facebook-star`
- **Source:** Facebook
- **Event list label:** Stars

## Default message template

```text
{{username}} sent {{amount}} stars
```
...
- `RANDOM`
- `EQUAL_NUMBER` - Stars Amount is equal to
- `GREATER_NUMBER` - Stars Amount is greater than or equal to
- `EQUAL_USERNAME`
- `EQUAL_VARIABLE`
