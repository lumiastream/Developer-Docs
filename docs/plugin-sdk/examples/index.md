...
- [Mawakit](./mawakit) - Prayer time alerts, Hijri date variables, and Ramadan reminders based on your location.
- [Minecraft Server](./minecraft-server) - Monitor Minecraft Java servers for status and player changes with alerts and variables.
- [ntfy](./ntfy) - Subscribe to ntfy topics and trigger Lumia alerts/variables for incoming notifications.
...
- [RSS Feed Monitor](./rss-feed-monitor) - Monitor multiple RSS or Atom feeds, persist unseen items, and trigger Lumia alerts for each new entry even after Lumia has been offline.
