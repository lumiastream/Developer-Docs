...
Lumia ships [44 default chatbot commands](/docs/chatbot/default-commands) out of the box: `!so`, `!roulette`, `!duel`, `!points`, `!songrequest`, and more. You can add, edit, and delete commands programmatically from any template using variable functions:
